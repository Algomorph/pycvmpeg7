...
GetColorQuantizerDescriptor(void) const
{
  return m_Quantizer;
}
...
//----------------------------------------------------------------------------
ColorSpaceDescriptor* DominantColorDescriptor::GetColorSpaceDescriptor () const
{
  return m_ColorSpace;
}
...
//----------------------------------------------------------------------------
int DominantColorDescriptor::GetDominantColorsNumber() const
{
  return (m_DominantColorsNumber);
}

//----------------------------------------------------------------------------
int DominantColorDescriptor::GetSpatialCoherency() const
{
  return (m_SpatialCoherency);
}

//----------------------------------------------------------------------------
DOMCOL* DominantColorDescriptor::GetDominantColors() const
{
  return (m_dc);
}
