...
public:
  ...
  // accessor methods
  virtual ColorQuantizerDescriptor* GetColorQuantizerDescriptor() const;
  virtual unsigned long SetColorQuantizerDescriptor(ColorQuantizerDescriptor *);
  virtual ColorSpaceDescriptor* GetColorSpaceDescriptor() const;
  virtual unsigned long SetColorSpaceDescriptor(ColorSpaceDescriptor *);

  virtual int GetDominantColorsNumber() const;
  virtual bool GetColorSpacePresent() const {return m_ColorSpacePresent;};
  virtual bool GetColorQuantizationPresent() const {return m_ColorQuantizationPresent;};
  virtual bool GetVariancePresent() const {return m_VariancePresent;};
  virtual int GetSpatialCoherency() const;
  virtual DOMCOL* GetDominantColors() const;
