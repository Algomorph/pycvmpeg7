...
//----------------------------------------------------------------------------
bool ColorSpaceDescriptor::GetColorReferenceFlag(void) const
{
...
//----------------------------------------------------------------------------
ColorSpaceType ColorSpaceDescriptor::GetDescriptionColorSpace(void) const
{
...
//----------------------------------------------------------------------------
const float* ColorSpaceDescriptor::GetColorSpaceMatrix(void) const
{
...
//----------------------------------------------------------------------------
float ColorSpaceDescriptor::GetMatrixElement(int xindex,int yindex) const
{
	if (xindex < 0 || xindex >= 3 || yindex < 0 || yindex >= 3)
#ifndef STH
		return -1;
