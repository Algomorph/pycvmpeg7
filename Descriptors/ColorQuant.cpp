...
//----------------------------------------------------------------------------
int ColorQuantizerDescriptor::GetComponent(int order) const
{
...
//----------------------------------------------------------------------------
int ColorQuantizerDescriptor::GetBinNumber(int order) const
{
...
//----------------------------------------------------------------------------
int ColorQuantizerDescriptor::GetBinNumberByComponent(int component) const
{
	int i;
	int NumComponents = 3;
	int ColorSpace = 0;
