...
public:
	...
	unsigned long* m_ScalableHistogram;  // An array of m_NumberOfCoefficients	Coefficients representing the frequency of each quantized value in the  source media
